...
public class Contratacion implements Cloneable, Serializable {
	...
	/**
	 * Es el metodo encargado de devolver la promo.<br>
	 * <br>
	 * <b>Pre</b>:<br>
	 * <b>Inv</b>:<br>
	 * <b>Post</b>: devuelve una prmo.<br>
	 * @return la promo de la contratacion.<br>
	 */
	...
	/**
	 * Es el metodo encargado de devolver la lista de servicios.<br>
	 * <br>
	 * <b>Pre</b>:<br>
	 * <b>Inv</b>:<br>
	 * <b>Post</b>: devuelve la lista de servicios.<br>
	 * @return la lista de servicios.<br>
	 */
	public ArrayList<Servicio> getListaServicio() {
		return this.listaServicio;
	}
	/**
	 * Es el metodo encargado de eliminar un servicio lista de servicios.<br>
	 * <br>
	 * <b>Pre</b>:el servicio no puede ser null<br>
	 * <b>Inv</b>:<br>
	 * <b>Post</b>: remueve o no un servicio de la lista de servicios.<br>
	 */
